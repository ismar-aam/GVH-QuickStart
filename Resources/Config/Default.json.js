{
  "configuration": {
    ...
    "modules": [
      ...
      {
        "moduleName": "CommandsAndEvents",
        "moduleType": "quickstart.CommandsAndEvents.CommandsAndEventsModule",
        "libraryId": "Custom",
        "views": [
          {
            "id": "CommandsAndEventsView",
            "markup": "Modules/CommandsAndEvents/CommandsAndEventsView.html",
            "viewModelId": "CommandsAndEventsViewModel",
            "region": "DataRegion",
            "visible": true,
            "type": "quickstart.commandsandevents.CommandsAndEventsView"
          }
        ],

        "viewModels": [
          {
            "id": "CommandsAndEventsViewModel",
            "type": "quickstart.commandsandevents.CommandsAndEventsViewModel"
          }
        ]
      },
      {
